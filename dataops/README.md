...
The 'fashion_rec_dataops' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/fashion_rec_dataops/`: Shared Python code that can be used by jobs and pipelines.
